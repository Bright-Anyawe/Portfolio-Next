    ...
    <section className="flex flex-col items-center xl:items-start xl:flex-row gap-8 p-6 xl:p-12">
      <div className="text-center xl:text-left order-2 xl:order-none">
        ...
        <h1 className="h1 mb-6">
          Hello I am <br /> <span className="text-accent">Anyawe Bright</span>
        </h1>
        ...
        <p className="max-w-[500px] mb-9 text-black">
          ...
          Explore my work to witness my inventiveness! Should you be interested,
      ...
      <div className="order-1 xl:order-none mb-8 xl:mb-0">
        <div className="relative">
          ...
          {/* SVG with circle */}
          <svg
            className="w-[300px] xl:w-[506px] h-[300px] xl:h-[406px] animate-spin-slow"
            fill="transparent"
            viewBox="0 0 506 506"
            xmlns="http://www.w3.org/2000/svg"
          >
